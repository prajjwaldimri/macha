<template>
  <div class="px-5 pt-5">
    ...
    <h1>Privacy Policy for macha</h1>

    <p>
      At macha.in, accessible from https://macha.in, one of our main priorities
      is the privacy of our visitors. This Privacy Policy document contains
      types of information that is collected and recorded by macha.in and how we
      use it.
    </p>
    ...
    <p>
      ...
      and/or collect in macha.in. This policy is not applicable to any
    ...
    <p>
      macha.in follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, macha.in uses 'cookies'. These cookies are used to
    ...
    <P
      ...
      advertising partners of macha.in.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on macha.in, which are sent directly
    ...
    <p>
      Note that macha.in has no access to or control over these cookies that are
    ...
    <p>
      macha.in's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      macha.in does not knowingly collect any Personal Identifiable Information
