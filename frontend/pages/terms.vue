<template>
  <div class="px-5 pt-5">
    <v-btn to="/" nuxt color="primary" block class="mb-3">GO HOME</v-btn>
    <h2><strong>Terms and Conditions</strong></h2>

    <p>Welcome to macha.in!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of macha's Website, located at https://macha.in.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use macha.in if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing macha.in, you agreed to use
      cookies in agreement with the macha's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, macha and/or its licensors own the intellectual
      property rights for all material on macha.in. All intellectual property
      rights are reserved. You may access this from macha.in for your own
      personal use subjected to restrictions set in these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from macha.in</li>
      <li>Sell, rent or sub-license material from macha.in</li>
      <li>Reproduce, duplicate or copy material from macha.in</li>
      <li>Redistribute content from macha.in</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. macha does not
      filter, edit, publish or review Comments prior to their presence on the
      website. Comments do not reflect the views and opinions of macha,its
      ...
      applicable laws, macha shall not be liable for the Comments or for any
    ...
    <p>
      macha reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant macha a non-exclusive license to use, reproduce, edit and
    ...
    <p>
      ...
      hyperlink compensates the absence of macha; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to macha. Please include your name, your organization name, contact
    ...
    <p>
      No use of macha's logo or other artwork will be allowed for linking absent
    ...
    <p>
      Please read
      <v-btn text to="/privacy" nuxt>Privacy Policy</v-btn>
    </p>
