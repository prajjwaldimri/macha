    ...
    v-dialog(v-model="changeProfilePictureDialog")
      v-card(max-height="100%" :loading="isProfileImageLoading")
        v-container.px-0
          ...
          VueCropper(ref="profileCropper" :src="profileImage" :zoomOnWheel="false" :zoomOnTouch="false" :minCropBoxWidth="80" :minCropBoxHeight="100" :aspectRatio="1" dragMode="move" style="max-height: 300px").pt-2
